...
* The version `1.0.6` will be used
...
```shell
helm install operaton operaton/operaton --version 1.0.6 -n YOUR_NAMESPACE
```
...
operaton                default         1               2025-02-28 10:20:34.586319 +0100 CET    deployed        operaton-1.0.6              2.1.0
```
